      ...
      <>
        <div className="relative bg-primary-contrast w-full overflow-hidden flex flex-col items-center justify-start gap-[69px] text-center text-lg text-primary-contrast font-components-button-large hover:[background:linear-gradient(#fff,_#fff),_#87550a] sm:w-full sm:hover:bg-orange-200">
          <div className="self-stretch flex flex-col items-center justify-start text-42xl font-baloo-bhai">
            ...
            <div className="w-[1440px] h-[639.91px] flex flex-col items-center justify-center bg-[url(/public/search-section@3x.png)] bg-cover bg-no-repeat bg-[top]">
              <div className="w-full h-[640px] flex flex-col py-0 px-[140px] box-border items-center justify-center gap-[43px] md:pl-[30px] md:pr-[30px] md:box-border">
                ...
                <div className="self-stretch rounded-3xs bg-primary-contrast flex flex-col p-5 items-start justify-start gap-[4px] text-left text-xl text-darkslategray-300 font-components-button-large md:flex-col sm:mt-5">
                  <div className="self-stretch overflow-hidden flex flex-row p-[5px] items-center justify-start gap-[5px] sm:flex-col sm:items-start">
                    ...
                    <div className="flex flex-row items-center justify-start sm:w-full">
                      <div className="w-[216.53px] h-[38px] flex flex-row items-center justify-start gap-[20px] sm:w-[100%!important]">
                        <FormControlLabel
                          label="Return"
                          labelPlacement="end"
                  ...
                  <div className="self-stretch flex flex-col items-start justify-center gap-[20px] text-lg text-lightgray md:w-full">
                    ...
                    <div className="self-stretch flex flex-row items-start justify-between sm:flex-row sm:text-center sm:flex-wrap sm:justify-between sm:ml-[-28px] sm:mr-[-28px]">
                      ...
                      <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-center justify-center gap-[8px] sm:pb-5 sm:box-border sm:w-[33.33%] sm:text-center">
                        <img
                          className="relative rounded-2xl w-[65.39px] h-[65.39px]"
                          alt=""
                      ...
                      <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-center justify-center gap-[8px] sm:pb-5 sm:box-border sm:w-[33.33%] sm:text-center">
                        <img
                          className="relative rounded-2xl w-[70px] h-[65.39px]"
                          alt=""
                          src="/taxi-icon.svg"
                        />
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[24px] text-cornflowerblue-300">
              ...
              <div className="self-stretch flex flex-row items-start justify-start ml-[-16px] mr-[-16px] md:ml-[-16px] md:mr-[-16px] md:flex-wrap md:mt-[-16px] md:mb-[-16px]">
                <button className="cursor-pointer [border:none] py-0 px-4 bg-[transparent] w-3/12 flex flex-col box-border items-center justify-center md:p-4 md:box-border md:w-6/12 sm:w-full">
                  <div className="w-72 h-[182px] overflow-hidden shrink-0 flex flex-col py-0 px-[0.29296875px] box-border items-start justify-start bg-[url(/public/pariscard@3x.png)] bg-cover bg-no-repeat bg-[top]">
                    <div className="w-[287.41px] flex flex-row py-2 px-3 box-border items-start justify-start">
                      ...
                      <div className="w-[90.92px] h-[59px] flex flex-col items-end justify-start gap-[2px]">
                ...
                <button className="cursor-pointer [border:none] py-0 px-4 bg-[transparent] w-3/12 flex flex-col box-border items-center justify-center md:p-4 md:box-border md:w-6/12 sm:w-full">
                  <div className="w-72 h-[182px] overflow-hidden shrink-0 flex flex-col py-0 px-[0.29296875px] box-border items-start justify-start bg-[url(/public/greececard@3x.png)] bg-cover bg-no-repeat bg-[top]">
                    <div className="w-[287.41px] flex flex-row py-2 px-3 box-border items-start justify-start">
                      <b className="flex-1 relative text-xl tracking-[0.02em] font-components-button-large text-primary-contrast text-left">
                        Greece
                      </b>
                      <div className="w-[99.92px] h-[59px] flex flex-col items-end justify-start gap-[2px]">
                        <div className="relative text-base tracking-[0.04em] uppercase font-components-button-large text-primary-contrast text-right inline-block w-[52.53px]">
                          from
                        </div>
                ...
                <button className="cursor-pointer [border:none] py-0 px-4 bg-[transparent] w-3/12 flex flex-col box-border items-center justify-center md:p-4 md:box-border md:w-6/12 sm:w-full">
                  <div className="w-72 h-[182px] overflow-hidden shrink-0 flex flex-col py-0 px-[0.29296875px] box-border items-start justify-start bg-[url(/public/norwaycard@3x.png)] bg-cover bg-no-repeat bg-[top]">
                    <div className="w-[287.41px] flex flex-row py-2 px-3 box-border items-start justify-start">
                      <b className="flex-1 relative text-xl tracking-[0.02em] font-components-button-large text-primary-contrast text-left">
                        Norway
                      </b>
                ...
                <button className="cursor-pointer [border:none] py-0 px-4 bg-[transparent] w-3/12 flex flex-col box-border items-center justify-center md:p-4 md:box-border md:w-6/12 sm:w-full">
                  <div className="w-72 h-[182px] overflow-hidden shrink-0 flex flex-col py-0 px-[0.29296875px] box-border items-start justify-start bg-[url(/public/tuscanycard@3x.png)] bg-cover bg-no-repeat bg-[top]">
                    <div className="w-[287.41px] flex flex-row py-2 px-3 box-border items-start justify-start">
                      <b className="flex-1 relative text-xl tracking-[0.02em] font-components-button-large text-primary-contrast text-left">
                        Tuscany
                      </b>
                      <div className="w-[100.62px] h-[59px] flex flex-col items-end justify-start gap-[2px]">
                        <div className="relative text-base tracking-[0.04em] uppercase font-components-button-large text-primary-contrast text-right inline-block w-[52.53px]">
                          from
                        </div>
              ...
              <div className="self-stretch flex flex-row items-center justify-start ml-[-12px] mr-[-12px] text-base lg:pr-10 lg:box-border lg:ml-[-12px] lg:mr-[-50px] md:mr-[-50px] md:ml-[-12px] sm:flex-col sm:pr-0 sm:box-border sm:mr-[-12px] sm:ml-[-12px]">
                <div className="self-stretch flex-1 flex flex-row py-0 px-3 box-border items-start justify-center w-3/12 md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
                  <div className="self-stretch flex-1 rounded-3xs bg-primary-contrast box-border flex flex-col py-[15px] px-[13px] items-start justify-start gap-[23px] w-3/12 border-[1px] border-solid border-whitesmoke-200 hover:bg-gainsboro-200 hover:cursor-pointer lg:w-[25%!important] md:w-full sm:w-[100%!important] sm:mb-5">
                    ...
                    <div className="w-[270px] h-[19px] flex flex-row items-center justify-start gap-[9px]">
                      <div className="w-[44.34px] h-[19px] flex flex-row items-center justify-start gap-[3px]">
                        <img
                      ...
                      <div className="relative tracking-[0.04em] text-cornflowerblue-200 inline-block w-[216.37px] shrink-0">
                        (60 reviews)
                      </div>
                    </div>
                ...
                <div className="self-stretch flex-1 flex flex-row py-0 px-3 box-border items-start justify-center w-3/12 md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
                  <div className="self-stretch flex-1 rounded-3xs bg-primary-contrast box-border flex flex-col py-[15px] px-[13px] items-start justify-start gap-[23px] w-3/12 border-[1px] border-solid border-whitesmoke-200 hover:bg-gainsboro-200 hover:cursor-pointer lg:w-[25%!important] md:w-full sm:flex sm:w-[100%!important]">
                    ...
                    <div className="w-[270px] h-[19px] flex flex-row items-center justify-start gap-[9px]">
                      <div className="w-[44.38px] h-[19px] flex flex-row items-center justify-start gap-[3px]">
                        <img
                          className="relative w-[16.68px] h-[17.19px]"
                          alt=""
                          src="/vector6.svg"
                        />
                        <div className="relative tracking-[0.04em] font-medium inline-block w-6 shrink-0">
                      ...
                      <div className="relative tracking-[0.04em] text-cornflowerblue-200 inline-block w-[216.27px] shrink-0">
                        (78 reviews)
                      </div>
                    </div>
                    <button className="cursor-pointer p-0 bg-[transparent] self-stretch rounded box-border h-[46px] overflow-hidden shrink-0 flex flex-col items-center justify-center border-[1px] border-solid border-lavender sm:w-[100%!important]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start text-cornflowerblue-300">
            <div className="w-[1440px] h-[529px] overflow-hidden shrink-0 flex flex-col py-[42px] px-0 box-border items-center justify-end bg-[url(/public/subscribe-section@3x.png)] bg-cover bg-no-repeat bg-[top]">
              <div className="w-[549px] flex flex-col p-5 box-border items-center justify-start gap-[30px] ml-[auto] mr-[auto] [position:relative!important] left-[auto!important] md:py-6 md:px-0 md:box-border sm:pl-6 sm:pr-6 sm:box-border sm:ml-[auto] sm:mr-[auto] sm:[position:relative!important] sm:left-[auto!important] sm:w-full">
                ...
                <div className="self-stretch rounded-xs bg-primary-contrast shadow-[0px_0px_24px_rgba(0,_0,_0,_0.03)] flex flex-col py-7 px-[30px] items-start justify-start gap-[17px] text-left text-slategray border-[1px] border-solid border-whitesmoke-200">
